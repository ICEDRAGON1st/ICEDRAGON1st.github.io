(function () {
  ...
  function camPose() {
    ...
    return { z: camZ, y: groundY(camZ) + CAM_HEIGHT + camFollowY };
  }
  ...
  function updateFall(dt) {
    ...
    const targetCam = Math.min(0, ballH * 0.92 - 0.6);
    camFollowY += (targetCam - camFollowY) * Math.min(1, 5.5 * dt);
    ...
    if (fallTimer > 1.45 || ballH < -18 || camFollowY < -14) {
