(function () {
  ...
  const ADMIN_MAX_MINUTES = 1440; // 24h
  ...
  const SPOTS = [
    ...
    },
    {
      ...
      valueMult: 68000,
      rarity: 66,
      blurb: "Past the origin · true omega shelf"
    },
    {
      id: "sovereigngate",
      name: "Sovereign Gate",
      ...
      valueMult: 82000,
      rarity: 67,
      blurb: "Royal doorway · sovereign tides rule"
    },
    {
      id: "celestialrift",
      name: "Celestial Rift",
      ...
      valueMult: 100000,
      rarity: 68,
      blurb: "Sky tear · celestial hauls pour in"
    },
    {
      id: "primordialend",
      name: "Primordial End",
      ...
      valueMult: 120000,
      rarity: 69,
      blurb: "First seas finished · primordial peak"
    },
    {
      id: "mythoshorizon",
      name: "Mythos Horizon",
      ...
      valueMult: 145000,
      rarity: 70,
      blurb: "Legend edge · mythos rarities rewrite"
    },
    {
      id: "continuumpeak",
      name: "Continuum Peak",
      ...
      valueMult: 175000,
      rarity: 71,
      blurb: "Time summit · continuum odds crest"
    },
    {
      id: "beyondgate",
      name: "Beyond Gate",
      ...
      valueMult: 210000,
      rarity: 72,
      blurb: "Door past apex · beyond gate endgame"
    },
    {
      id: "finalmere",
      name: "Final Mere",
      ...
      valueMult: 255000,
      rarity: 73,
      blurb: "Last still water · final mere pays all"
    },
    {
      id: "absoluterift",
      name: "Absolute Rift",
      ...
      valueMult: 310000,
      rarity: 74,
      blurb: "Torn absolute · rarities without ceiling"
    },
    {
      id: "ultimatedock",
      name: "Ultimate Dock",
      ...
      valueMult: 380000,
      rarity: 75,
      blurb: "End of the map · ultimate dock waits"
    }
  ];

  const MAX_SPOT_RARITY = 75;
  ...
  const GEAR = [
    ...
    { id: "rod72", name: "Sovereign Horizon Rod", desc: "+2.15s bite window", cost: 3e46, kind: "window", amount: 2.15 },
    { id: "rod73", name: "Celestial Apex Rod", desc: "+2.2s bite window", cost: 1.5e47, kind: "window", amount: 2.2 },
    { id: "rod74", name: "Primordial End Rod", desc: "+2.25s bite window", cost: 7.5e47, kind: "window", amount: 2.25 },
    { id: "rod75", name: "Ultimate Dock Rod", desc: "+2.3s bite window", cost: 3.8e48, kind: "window", amount: 2.3 },
    { id: "bait64", name: "Sovereign Chum", desc: "Faster bites (−99.96% wait)", cost: 1.2e46, kind: "speed", amount: 0.9996 },
    { id: "bait65", name: "Celestial Roe", desc: "Faster bites (−99.97% wait)", cost: 6e46, kind: "speed", amount: 0.9997 },
    { id: "bait66", name: "Primordial Flies", desc: "Faster bites (−99.98% wait)", cost: 3e47, kind: "speed", amount: 0.9998 },
    { id: "bait67", name: "Ultimate Dock Bait", desc: "Faster bites (−99.985% wait)", cost: 1.5e48, kind: "speed", amount: 0.99985 },
    { id: "luck71", name: "Sovereign Oracle", desc: "+240000000 luck · better chest finds", cost: 9e46, kind: "luck", amount: 240000000 },
    { id: "luck72", name: "Celestial Charm", desc: "+300000000 luck · better chest finds", cost: 4.5e47, kind: "luck", amount: 300000000 },
    { id: "luck73", name: "Primordial Hook", desc: "+380000000 luck · better chest finds", cost: 2.2e48, kind: "luck", amount: 380000000 },
    { id: "luck74", name: "Ultimate Dock Oracle", desc: "+480000000 luck · better chest finds", cost: 1.1e49, kind: "luck", amount: 480000000 },
    { id: "cooler69", name: "Sovereign Hold XL", desc: "+9500000 cooler slots", cost: 1.5e46, kind: "cooler", amount: 9500000 },
    { id: "cooler70", name: "Celestial Vault XL", desc: "+12000000 cooler slots", cost: 7.5e46, kind: "cooler", amount: 12000000 },
    { id: "cooler71", name: "Primordial Cage XL", desc: "+15000000 cooler slots", cost: 3.8e47, kind: "cooler", amount: 15000000 },
    { id: "cooler72", name: "Ultimate Dock Hold", desc: "+19000000 cooler slots", cost: 1.9e48, kind: "cooler", amount: 19000000 },
    { id: "sell68", name: "Sovereign Exchange", desc: "+6200000% sell value", cost: 1.2e47, kind: "value", amount: 62000 },
    { id: "sell69", name: "Celestial Floor", desc: "+7800000% sell value", cost: 6e47, kind: "value", amount: 78000 },
    { id: "sell70", name: "Primordial Market", desc: "+9800000% sell value", cost: 3e48, kind: "value", amount: 98000 },
    { id: "sell71", name: "Ultimate Dock Pit", desc: "+12500000% sell value", cost: 1.5e49, kind: "value", amount: 125000 },
    { id: "net55", name: "Sovereign Net", desc: "99.996% chance for a second fish", cost: 2.8e39, kind: "multi", amount: 0.99996 },
    { id: "net56", name: "Celestial Mesh", desc: "99.997% chance for a second fish", cost: 1.4e40, kind: "multi", amount: 0.99997 },
    { id: "net57", name: "Primordial Snare", desc: "99.998% chance for a second fish", cost: 7e40, kind: "multi", amount: 0.99998 },
    { id: "net58", name: "Ultimate Dock Net", desc: "99.999% chance for a second fish", cost: 3.5e41, kind: "multi", amount: 0.99999 },
    { id: "triple52", name: "Sovereign Trident", desc: "99.985% chance for a third fish (needs 2nd catch)", cost: 3.8e39, kind: "triple", amount: 0.99985 },
    { id: "triple53", name: "Celestial Triad", desc: "99.99% chance for a third fish (needs 2nd catch)", cost: 1.9e40, kind: "triple", amount: 0.9999 },
    { id: "triple54", name: "Primordial Trident", desc: "99.994% chance for a third fish (needs 2nd catch)", cost: 9.5e40, kind: "triple", amount: 0.99994 },
    { id: "triple55", name: "Ultimate Dock Triad", desc: "99.997% chance for a third fish (needs 2nd catch)", cost: 4.8e41, kind: "triple", amount: 0.99997 },
    { id: "perfect64", name: "Sovereign Focus", desc: "+2450000% sell on perfect reels", cost: 2.4e46, kind: "perfect", amount: 24500 },
    { id: "perfect65", name: "Celestial Pulse", desc: "+3100000% sell on perfect reels", cost: 1.2e47, kind: "perfect", amount: 31000 },
    { id: "perfect66", name: "Primordial Timing", desc: "+3900000% sell on perfect reels", cost: 6e47, kind: "perfect", amount: 39000 },
    { id: "perfect67", name: "Ultimate Dock Focus", desc: "+4900000% sell on perfect reels", cost: 3e48, kind: "perfect", amount: 49000 },
    { id: "looks31", name: "Sovereign Gleam", desc: "+12500% shiny & variant odds", cost: 5e27, kind: "looks", amount: 125 },
    { id: "looks32", name: "Celestial Polish", desc: "+15500% shiny & variant odds", cost: 3.5e28, kind: "looks", amount: 155 },
    { id: "looks33", name: "Primordial Sheen", desc: "+19500% shiny & variant odds", cost: 2.5e29, kind: "looks", amount: 195 },
    { id: "looks34", name: "Mythos Shine", desc: "+24500% shiny & variant odds", cost: 1.8e30, kind: "looks", amount: 245 },
    { id: "looks35", name: "Continuum Gleam", desc: "+31000% shiny & variant odds", cost: 1.2e31, kind: "looks", amount: 310 },
    { id: "looks36", name: "Beyond Apex Polish", desc: "+39000% shiny & variant odds", cost: 8e31, kind: "looks", amount: 390 },
    { id: "looks37", name: "Final Mere Sheen", desc: "+49000% shiny & variant odds", cost: 5.5e32, kind: "looks", amount: 490 },
    { id: "looks38", name: "Ultimate Dock Gleam", desc: "+62000% shiny & variant odds", cost: 3.8e33, kind: "looks", amount: 620 },
    { id: "quad28", name: "Sovereign Quad", desc: "98.8% chance for a 4th fish (needs 3rd)", cost: 7e27, kind: "quad", amount: 0.988 },
    { id: "quad29", name: "Celestial Quad", desc: "99% chance for a 4th fish (needs 3rd)", cost: 5e28, kind: "quad", amount: 0.99 },
    { id: "quad30", name: "Primordial Quad", desc: "99.2% chance for a 4th fish (needs 3rd)", cost: 3.5e29, kind: "quad", amount: 0.992 },
    { id: "quad31", name: "Mythos Quad Ultima", desc: "99.4% chance for a 4th fish (needs 3rd)", cost: 2.5e30, kind: "quad", amount: 0.994 },
    { id: "quad32", name: "Continuum Quad", desc: "99.5% chance for a 4th fish (needs 3rd)", cost: 1.8e31, kind: "quad", amount: 0.995 },
    { id: "quad33", name: "Beyond Apex Quad Ultima", desc: "99.6% chance for a 4th fish (needs 3rd)", cost: 1.2e32, kind: "quad", amount: 0.996 },
    { id: "quad34", name: "Final Mere Quad", desc: "99.7% chance for a 4th fish (needs 3rd)", cost: 8e32, kind: "quad", amount: 0.997 },
    { id: "quad35", name: "Ultimate Dock Quad", desc: "99.8% chance for a 4th fish (needs 3rd)", cost: 5.5e33, kind: "quad", amount: 0.998 },
    { id: "chest28", name: "Sovereign Finder", desc: "+24500% chest find odds", cost: 5.5e25, kind: "chest", amount: 245 },
    { id: "chest29", name: "Celestial Magnet", desc: "+31000% chest find odds", cost: 3.8e26, kind: "chest", amount: 310 },
    { id: "chest30", name: "Primordial Diviner", desc: "+39000% chest find odds", cost: 2.5e27, kind: "chest", amount: 390 },
    { id: "chest31", name: "Mythos Salvage", desc: "+49000% chest find odds", cost: 1.8e28, kind: "chest", amount: 490 },
    { id: "chest32", name: "Continuum Cache", desc: "+62000% chest find odds", cost: 1.2e29, kind: "chest", amount: 620 },
    { id: "chest33", name: "Beyond Apex Hoard", desc: "+78000% chest find odds", cost: 8e29, kind: "chest", amount: 780 },
    { id: "chest34", name: "Final Mere Finder", desc: "+98000% chest find odds", cost: 5.5e30, kind: "chest", amount: 980 },
    { id: "chest35", name: "Ultimate Dock Diviner", desc: "+125000% chest find odds", cost: 3.8e31, kind: "chest", amount: 1250 },
    { id: "combo28", name: "Sovereign Cadence", desc: "+3900s combo hold", cost: 1.2e26, kind: "combo", amount: 3900 },
    { id: "combo29", name: "Celestial Rhythm", desc: "+4900s combo hold", cost: 8e26, kind: "combo", amount: 4900 },
    { id: "combo30", name: "Primordial Tempo", desc: "+6200s combo hold", cost: 5.5e27, kind: "combo", amount: 6200 },
    { id: "combo31", name: "Mythos Beat", desc: "+7800s combo hold", cost: 3.8e28, kind: "combo", amount: 7800 },
    { id: "combo32", name: "Continuum Flow", desc: "+9800s combo hold", cost: 2.5e29, kind: "combo", amount: 9800 },
    ...
    { id: "penta31", name: "Mythos Penta Gate", desc: "99.6% chance for a 5th fish (needs 4th)", cost: 9.5e30, kind: "penta", amount: 0.996 },
    { id: "penta32", name: "Continuum Penta", desc: "99.7% chance for a 5th fish (needs 4th)", cost: 6.5e31, kind: "penta", amount: 0.997 },
    { id: "penta33", name: "Beyond Apex Penta Ultima", desc: "99.8% chance for a 5th fish (needs 4th)", cost: 4.5e32, kind: "penta", amount: 0.998 },
    { id: "penta34", name: "Final Mere Penta", desc: "99.85% chance for a 5th fish (needs 4th)", cost: 3e33, kind: "penta", amount: 0.9985 },
    { id: "penta35", name: "Ultimate Dock Penta", desc: "99.9% chance for a 5th fish (needs 4th)", cost: 2e34, kind: "penta", amount: 0.999 }
  ];
