...
(function () {
  ...
  const DEFINITIONS = [
    ...
    { id: "wordle_first_win",    emoji: "🟩", name: "First Blood",     desc: "Win your first Guessword" },
    { id: "wordle_daily",        emoji: "📅", name: "Daily Solver",     desc: "Solve today's Daily Guessword" },
    { id: "hangman_win",         emoji: "🪢", name: "Saved",           desc: "Win a game of Hangman" },
    { id: "connect4_win",        emoji: "🔴", name: "Connected",       desc: "Win a game of Drop Four" },
    ...
    { id: "flappy_score_5",      emoji: "🐦", name: "Wing It",         desc: "Score 5 in Wing Hop" },
    { id: "dino_score_20",       emoji: "🦖", name: "First Sprint",    desc: "Score 20 in Runosaur" },
    { id: "ramp_score_25",       emoji: "🌀", name: "First Roll",      desc: "Score 5 in Ramp Rush" },
    { id: "guac_score_10",       emoji: "🥑", name: "First Mash",      desc: "Score 10 in Guac-A-Mole" },
    { id: "bubble_score_50",     emoji: "🫧", name: "First Pop",       desc: "Score 50 in Bubble Pop Relay" },
    { id: "cafe_serve_10",       emoji: "☕", name: "Barista Trainee", desc: "Serve 10 guests in Cafe Queue" },
    { id: "garden_harvest_8",    emoji: "🌱", name: "First Sprout",    desc: "Harvest 8 crops in Garden Snap" },
    { id: "blockblast_score_250", emoji: "🟦", name: "Block Starter",  desc: "Score 250 in Block Sweep" },
    { id: "lemmings_save_1",     emoji: "🟩", name: "First Rescue",   desc: "Save a dude" },
    { id: "mine_depth_50",       emoji: "⛏️", name: "First Dig",       desc: "Reach 50m in Mine Depth" },
    { id: "breakout_score_100",  emoji: "🧱", name: "Brick Starter",   desc: "Score 100 in Bounce Break" },
    ...
    { id: "2048_tile_512",       emoji: "🔢", name: "Getting There",   desc: "Reach the 512 tile in Block Merge" },
    { id: "pixletris_lines_5",   emoji: "🟦", name: "Line Clearer",    desc: "Clear 5 lines in Pixel Drop" },
    ...
    { id: "crossy_score_5",      emoji: "🐔", name: "First Crossing",  desc: "Reach lane 5 in Cross Walk" },
    ...
    // Medium
    { id: "wordle_guess_3",      emoji: "🧠", name: "Quick Thinker",   desc: "Win a Guessword in 3 guesses or fewer" },
    { id: "wordle_win_5",        emoji: "📚", name: "Word Nerd",        desc: "Win 5 Guesswords" },
    { id: "wordle_streak_3",     emoji: "📗", name: "Word Streak",     desc: "Win 3 Guesswords in a row" },
    ...
    { id: "connect4_win_3",      emoji: "🟡", name: "Four Streak",     desc: "Win Drop Four 3 times" },
    { id: "snake_score_50",      emoji: "🐍", name: "Snake Charmer",   desc: "Score 50 in Snake" },
    { id: "flappy_score_15",     emoji: "🐥", name: "Sky Hopper",      desc: "Score 15 in Wing Hop" },
    { id: "dino_score_50",       emoji: "🌵", name: "Cactus Dodger",   desc: "Score 50 in Runosaur" },
    { id: "ramp_score_75",       emoji: "🎢", name: "Ramp Runner",     desc: "Score 12 in Ramp Rush" },
    { id: "guac_score_30",       emoji: "🥣", name: "Bowl Filler",     desc: "Score 30 in Guac-A-Mole" },
    { id: "guac_combo_5",        emoji: "💥", name: "Guac Streak",     desc: "Hit a 5 combo in Guac-A-Mole" },
    { id: "bubble_score_150",    emoji: "🌊", name: "Tide Fighter",    desc: "Score 150 in Bubble Pop Relay" },
    { id: "cafe_score_80",       emoji: "🧁", name: "Rush Hour",       desc: "Score 80 in Cafe Queue" },
    { id: "cafe_combo_5",        emoji: "⭐", name: "Perfect Tickets", desc: "Hit a 5 combo in Cafe Queue" },
    { id: "garden_score_60",     emoji: "🧺", name: "Basket Filler",   desc: "Score 60 in Garden Snap" },
    { id: "blockblast_score_1000", emoji: "💥", name: "Line Blaster",  desc: "Score 1,000 in Block Sweep" },
    { id: "lemmings_level_1",    emoji: "🚪", name: "Door Open",      desc: "Clear Dudes level 1" },
    ...
    { id: "2048_tile_1024",      emoji: "🔟", name: "Four Digits",     desc: "Reach the 1024 tile in Block Merge" },
    { id: "breakout_clear",      emoji: "✨", name: "Clean Sweep",     desc: "Clear a full Bounce Break level" },
    { id: "stacker_score_15",    emoji: "🏙️", name: "Skyline",         desc: "Stack 15 floors in Tower Stack" },
    { id: "crossy_score_15",     emoji: "🚦", name: "Traffic Dodger",  desc: "Reach lane 15 in Cross Walk" },
    { id: "fishing_100k",        emoji: "⛵", name: "Harbor Pro",      desc: "Earn 100,000 coins in Fishing Idle" },
    { id: "fishing_fps_10",      emoji: "🛶", name: "First Boat",      desc: "Hire the auto boat in Fishing Idle" },
    ...
    { id: "breakout_score_500",  emoji: "🔨", name: "Wall Smasher",    desc: "Score 500 in Bounce Break" },
    ...
    { id: "pixletris_lines_20",  emoji: "🟪", name: "Stack Master",    desc: "Clear 20 lines in Pixel Drop" },
    ...
    // Hard
    { id: "wordle_guess_2",      emoji: "⚡", name: "Sharp Mind",      desc: "Win a Guessword in 2 guesses or fewer" },
    { id: "wordle_win_10",       emoji: "📖", name: "Lexicon",         desc: "Win 10 Guesswords" },
    ...
    { id: "flappy_score_30",     emoji: "🦅", name: "Pipe Dodger",     desc: "Score 30 in Wing Hop" },
    { id: "dino_score_100",      emoji: "🌙", name: "Night Runner",    desc: "Score 100 in Runosaur" },
    { id: "dino_score_200",      emoji: "🏁", name: "Fossil Fuel",     desc: "Reach a best of 200 in Runosaur" },
    { id: "ramp_score_150",      emoji: "⚡", name: "Teal Comet",      desc: "Score 25 in Ramp Rush" },
    { id: "ramp_score_250",      emoji: "🏆", name: "Ramp Master",     desc: "Reach a best of 40 in Ramp Rush" },
    { id: "guac_score_60",       emoji: "🌶️", name: "Chip Dipper",     desc: "Score 60 in Guac-A-Mole" },
    { id: "guac_score_100",      emoji: "🏆", name: "Guac Legend",     desc: "Reach a best of 100 in Guac-A-Mole" },
    { id: "bubble_clear_40",     emoji: "💥", name: "Cluster Clear",   desc: "Clear 40 bubbles in one Bubble Pop run" },
    { id: "bubble_score_300",    emoji: "🏆", name: "Foam Master",     desc: "Reach a best of 300 in Bubble Pop Relay" },
    { id: "cafe_score_200",      emoji: "🏆", name: "Head Barista",    desc: "Reach a best of 200 in Cafe Queue" },
    { id: "garden_season_3",     emoji: "🍂", name: "Three Seasons",   desc: "Reach season 3 in Garden Snap" },
    { id: "garden_score_150",    emoji: "🏆", name: "Master Gardener", desc: "Reach a best of 150 in Garden Snap" },
    { id: "blockblast_score_2500", emoji: "🧩", name: "Grid Surgeon",  desc: "Score 2,500 in Block Sweep" },
    { id: "blockblast_score_5000", emoji: "🏆", name: "Blast Master",  desc: "Reach a best of 5,000 in Block Sweep" },
    { id: "lemmings_level_3",    emoji: "🪜", name: "Bridge Crew",    desc: "Clear 3 Dudes levels" },
    { id: "lemmings_all_levels", emoji: "🏁", name: "Tribe Saved",    desc: "Clear all Dudes levels" },
    { id: "lemmings_score_2000", emoji: "🎖️", name: "Mayhem Master", desc: "Score 2,000 in Dudes" },
    ...
    { id: "crossy_score_30",     emoji: "🌊", name: "River Runner",    desc: "Reach lane 30 in Cross Walk" },
    ...
    { id: "pixletris_score_1k",  emoji: "🟩", name: "Pixel Pro",       desc: "Score 1000 in Pixel Drop" },
    ...
    // Expert
    { id: "wordle_guess_1",      emoji: "🎯", name: "Lucky Shot",      desc: "Win a Guessword in 1 guess" },
    { id: "wordle_win_25",       emoji: "📕", name: "Word Wizard",     desc: "Win 25 Guesswords" },
