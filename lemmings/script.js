(function () {
  ...
  const LEVELS = [
    ...
    {
      name: "Double Gap",
      tip: "Two gaps — Build across each one. Block helpers if they crowd the builder.",
      release: 14,
      need: 8,
      rate: 0.9,
      skills: { blocker: 3, builder: 10, basher: 0, digger: 0, floater: 0, bomber: 0, climber: 0 },
      map: [
        "........................................",
        "........................................",
        "........................................",
    ...
    {
      name: "Bomb the Plug",
      tip: "Steel won't dig — Bomb a walker against the dirt plug to open the path.",
      release: 12,
      need: 7,
      rate: 0.95,
    ...
    {
      name: "High Road",
      tip: "Climb the short wall, then Build the gap to the steel road and OUT.",
      release: 12,
      need: 7,
      rate: 0.9,
